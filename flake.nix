  ...
  outputs = { self, nixpkgs, crane, rust-overlay, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        # (backends/zebra → zallet-zebra-state, backends/zaino → zallet-zaino),
        ...
        zallet-zebra-state = mkZallet {
          manifestDir = "backends/zebra";
          binName = "zallet-zebra-state";
        ...
        zallet = pkgs.symlinkJoin {
          name = "zallet";
          paths = [ zallet-launcher zallet-zebra-state zallet-zaino ];
        };
      in {
        packages.default = zallet;
        packages.zallet = zallet;
        packages.zallet-launcher = zallet-launcher;
        packages.zallet-zebra-state = zallet-zebra-state;
